...
pub const firebird_container_name = 'test_firebird_server'
pub const firebird_port = '3051'
pub const firebird_user = 'test_user'
pub const firebird_root_password = 'test_root_password'
pub const firebird_password = 'test_password'
pub const firebird_database = 'test_database.fdb'
pub const firebird_database_path = '/var/lib/firebird/data/${firebird_database}'
pub const firebird_url = 'firebird://${firebird_user}:${firebird_password}@localhost:${firebird_port}${firebird_database_path}'

// Remember to `sudo usermod -aG docker $USER`
pub fn container_firebird_clean() {
...
pub fn container_firebird_start() ! {
